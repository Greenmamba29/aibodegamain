...
const translations: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    'share_innovation': 'Comparte tu última innovación de IA con la comunidad',
    'manage_your_apps': 'Administra tus Aplicaciones',
    'update_edit_track': 'Actualiza, edita y rastrea tus aplicaciones publicadas',
    'your_profile': 'Tu Perfil',
    'manage_profile_settings': 'Administra tu perfil de desarrollador y configuración',
    'new_downloads_this_week': 'nuevas descargas esta semana',
    'new_followers': 'nuevos seguidores',
    'earned_from': 'ganados de',
    'recent_activity': 'Actividad Reciente',
    'manage_apps_description': 'Administra tus aplicaciones de IA y rastrea el rendimiento',
    'published_apps': 'Aplicaciones Publicadas',
    'drafts': 'Borradores',
    'submit_new_app': 'Enviar Nueva Aplicación',
    'no_apps_yet': 'Aún No Hay Aplicaciones',
    'no_apps_description': '¡Aún no has enviado ninguna aplicación. ¡Comienza enviando tu primera aplicación!',
    'submit_first_app': 'Envía Tu Primera Aplicación',
    'pending': 'Pendiente',
    'approved': 'Aprobado',
    'rejected': 'Rechazado',
    'archived': 'Archivado',
    ...
    'no_drafts_description': 'No tienes borradores guardados. ¡Comienza a crear una aplicación para guardar borradores!',
    'draft': 'Borrador',
    'manage_apps_description': 'Administra tus aplicaciones de IA y rastrea el rendimiento',
  },
  fr: {
    ...
    'share_innovation': 'Partagez votre dernière innovation IA avec la communauté',
    'manage_your_apps': 'Gérez Vos Applications',
    'update_edit_track': 'Mettez à jour, modifiez et suivez vos applications publiées',
    'your_profile': 'Votre Profil',
    'manage_profile_settings': 'Gérez votre profil développeur et vos paramètres',
    'new_downloads_this_week': 'nouveaux téléchargements cette semaine',
    'new_followers': 'nouveaux abonnés',
    'earned_from': 'gagnés de',
    'recent_activity': 'Activité Récente',
    'manage_apps_description': 'Gérez vos applications IA et suivez les performances',
    'published_apps': 'Applications Publiées',
    'drafts': 'Brouillons',
    'submit_new_app': 'Soumettre Nouvelle Application',
    'no_apps_yet': 'Pas Encore d\'Applications',
    'no_apps_description': 'Vous n\'avez pas encore soumis d\'applications. Commencez par soumettre votre première application !',
    'submit_first_app': 'Soumettre Votre Première Application',
    'pending': 'En attente',
    'approved': 'Approuvé',
    'rejected': 'Rejeté',
    'archived': 'Archivé',
    ...
    'no_drafts_description': 'Vous n\'avez pas de brouillons enregistrés. Commencez à créer une application pour enregistrer des brouillons !',
    'draft': 'Brouillon',
    'manage_apps_description': 'Gérez vos applications IA et suivez les performances',
  },
  de: {
    ...
    'share_innovation': 'Teilen Sie Ihre neueste KI-Innovation mit der Community',
    'manage_your_apps': 'Verwalten Sie Ihre Apps',
    'update_edit_track': 'Aktualisieren, bearbeiten und verfolgen Sie Ihre veröffentlichten Anwendungen',
    'your_profile': 'Ihr Profil',
    'manage_profile_settings': 'Verwalten Sie Ihr Entwicklerprofil und Einstellungen',
    'new_downloads_this_week': 'neue Downloads diese Woche',
    'new_followers': 'neue Follower',
    'earned_from': 'verdient von',
    'recent_activity': 'Neueste Aktivitäten',
    'manage_apps_description': 'Verwalten Sie Ihre KI-Anwendungen und verfolgen Sie die Leistung',
    'published_apps': 'Veröffentlichte Apps',
    'drafts': 'Entwürfe',
    'submit_new_app': 'Neue App Einreichen',
    'no_apps_yet': 'Noch Keine Apps',
    'no_apps_description': 'Sie haben noch keine Apps eingereicht. Beginnen Sie mit der Einreichung Ihrer ersten App!',
    'submit_first_app': 'Erste App Einreichen',
    'pending': 'Ausstehend',
    'approved': 'Genehmigt',
    'rejected': 'Abgelehnt',
    'archived': 'Archiviert',
    ...
    'no_drafts_description': 'Sie haben keine gespeicherten Entwürfe. Beginnen Sie mit der Erstellung einer App, um Entwürfe zu speichern!',
    'draft': 'Entwurf',
    'manage_apps_description': 'Verwalten Sie Ihre KI-Anwendungen und verfolgen Sie die Leistung',
  },
  ja: {
    ...
    'my_apps': 'マイアプリ',
    'overview': '概要',
    'ready_to_submit': '提出する準備はできましたか？',
    'share_innovation': 'あなたの最新のAIイノベーションをコミュニティと共有しましょう',
    'manage_your_apps': 'アプリを管理する',
    'update_edit_track': '公開されたアプリケーションを更新、編集、追跡する',
    'your_profile': 'あなたのプロフィール',
    'manage_profile_settings': '開発者プロフィールと設定を管理する',
    'new_downloads_this_week': '今週の新しいダウンロード',
    'new_followers': '新しいフォロワー',
    'earned_from': 'から獲得',
    'recent_activity': '最近のアクティビティ',
    'manage_apps_description': 'AIアプリケーションを管理しパフォーマンスを追跡する',
    'published_apps': '公開済みアプリ',
    'drafts': '下書き',
    'submit_new_app': '新しいアプリを提出',
    'no_apps_yet': 'まだアプリがありません',
    'no_apps_description': 'まだアプリを提出していません。最初のアプリを提出しましょう！',
    'submit_first_app': '最初のアプリを提出',
    'pending': '保留中',
    'approved': '承認済み',
    'rejected': '拒否',
    'archived': 'アーカイブ',
    ...
    'docs': '文書',
    'no_drafts': '下書きなし',
    'no_drafts_description': '保存された下書きはありません。アプリの作成を開始して下書きを保存しましょう！',
    'draft': '下書き',
    'manage_apps_description': 'AIアプリケーションを管理しパフォーマンスを追跡する',
  },
  zh: {
    ...
    'share_innovation': '与社区分享您最新的AI创新',
    'manage_your_apps': '管理您的应用',
    'update_edit_track': '更新、编辑和跟踪您已发布的应用',
    'your_profile': '您的个人资料',
    'manage_profile_settings': '管理您的开发者资料和设置',
    'new_downloads_this_week': '本周新下载',
    'new_followers': '新粉丝',
    'earned_from': '来自以下应用的收入',
    'recent_activity': '最近活动',
    'manage_apps_description': '管理您的AI应用并跟踪性能',
    'published_apps': '已发布应用',
    'drafts': '草稿',
    'submit_new_app': '提交新应用',
    'no_apps_yet': '暂无应用',
    'no_apps_description': '您尚未提交任何应用。从提交您的第一个应用开始！',
    'submit_first_app': '提交您的第一个应用',
    'pending': '待审核',
    'approved': '已批准',
    'rejected': '已拒绝',
    'archived': '已归档',
    ...
    'docs': '文档',
    'no_drafts': '无草稿',
    'no_drafts_description': '您没有保存的草稿。开始创建应用以保存草稿！',
    'draft': '草稿',
    'manage_apps_description': '管理您的AI应用并跟踪性能',
  }
};
